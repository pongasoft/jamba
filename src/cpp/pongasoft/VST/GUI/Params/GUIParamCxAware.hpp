...
namespace Params {
   ...
   */
  template<typename T>
  GUIVstParam<T> GUIParamCxAware::registerVstCallback(ParamID iParamID, Parameters::ChangeCallback iChangeCallback)
  {
    if(fParamCxMgr)
   ...
   */
  template<typename T>
  GUIVstParam<T> GUIParamCxAware::registerCallback(VstParam<T> const &iParamDef, Parameters::ChangeCallback iChangeCallback)
  {
    if(fParamCxMgr)
   ...
   */
  template<typename T>
  GUIJmbParam<T> GUIParamCxAware::registerCallback(GUIJmbParam<T> &iParamDef, Parameters::ChangeCallback iChangeCallback)
  {
    if(fParamCxMgr)
   ...
   */
  template<typename T>
  bool GUIParamCxAware::registerCallback(GUIJmbParam<T> &iParamDef, Parameters::ChangeCallback1<GUIJmbParam<T>> iChangeCallback)
  {
    if(fParamCxMgr)
    {
   ...
   */
  template<typename T>
  GUIJmbParam<T> GUIParamCxAware::registerJmbCallback(ParamID iParamID, Parameters::ChangeCallback iChangeCallback)
  {
    if(fParamCxMgr)
